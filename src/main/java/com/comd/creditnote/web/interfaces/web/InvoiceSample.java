...
//
//    private static final Logger LOG = Logger.getLogger(InvoiceSample.class.getName());
//
//    public static final String ARIAL_BLACK = "fonts/arial_black.ttf";
//    private static Font midBold = new Font(Font.FontFamily.HELVETICA, 14, Font.BOLD);
//    private static Font subBold = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD);
...
////            Document layoutDocument = new Document(pageSize, 50, 20, 0, 0);
//            Document layoutDocument = new Document(pageSize, 55, 10, 0, 0);
...
//        table.setWidths(new float[]{1.5f, 2f, 3f, 2.5f, 1f});
//        //table.setWidths(new float[]{100, 200, 300, 350, 100});
//
...
//        table.addCell(getCell(String.format("%,d", creditNoteAdvice.getCreditNote().getAmount().getIntValue().intValue()), smallReg, PdfPCell.ALIGN_RIGHT));
...
//        footer.add(line1);
//
//        Paragraph line2 = new Paragraph("For: NIGERIAN NATIONAL PETROLEUM CORPORATION", smallBold);
//        footer.add(line2);
//
...
//        signTable.setWidths(new float[]{50f, 0f, 100f});
//        signTable.setWidthPercentage(100);
//
//        signTable.addCell(getCell("ABAH, A. L. (MRS)", f3, PdfPCell.ALIGN_LEFT));
//        signTable.addCell(getEmptyCell());
//        signTable.addCell(getCell("AMINA M. MOHAMMED", f3, PdfPCell.ALIGN_LEFT));
//
//        signTable.addCell(getCell("FOR: GGM, COMD", f3, PdfPCell.ALIGN_LEFT));
//        signTable.addCell(getEmptyCell());
//        signTable.addCell(getCell("SUPVR. C&P RECON. COMD", f3, PdfPCell.ALIGN_LEFT));
//
